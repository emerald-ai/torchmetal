...
def train(args):
    logger.warning(
        "This script is an example to showcase the extensions and "
    ...
    model = MatchingNetwork(1, args.embedding_size, hidden_size=args.hidden_size)
        ...
        for batch_idx, batch in enumerate(pbar):
            ...
            with torch.no_grad():
                ...
                log_probas = matching_log_probas(
                    train_embeddings, train_targets, test_embeddings, args.num_ways
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "folder", type=str, help="Path to the folder the data is downloaded to."
    )
    parser.add_argument(
        "--num-shots",
        type=int,
