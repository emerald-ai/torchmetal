...
from torchmetal.datasets import (Omniglot, MiniImagenet, TieredImagenet, CIFARFS,
                                FC100, CUB, DoubleMNIST, TripleMNIST, Pascal5i)
from torchmetal.transforms import Categorical, ClassSplitter, Rotation, SegmentationPairTransform
