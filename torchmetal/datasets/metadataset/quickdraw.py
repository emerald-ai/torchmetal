...
class Quickdraw(CombinationMetaDataset):
    ...
    ----------
    root : string
        Root directory where the dataset folder `quickdraw` exists.
    ...
    convert : bool (default: `False`)
        ...
        directory (under the `quickdraw` folder). If the dataset is already
...
class QuickdrawClassDataset(ClassDataset):
    def __init__(
        ...
        super(QuickdrawClassDataset, self).__init__(
            meta_dataset=meta_dataset,
            meta_train=meta_train,
            meta_val=meta_val,
            meta_test=meta_test,
    ...
    def convert(self):
        ...
        convert(self.root, dataset="quickdraw")
