...
class Aircraft(CombinationMetaDataset):
    ...
    ----------
    root : string
        Root directory where the dataset folder `aircraft` exists.
    ...
    convert : bool (default: `False`)
        ...
        directory (under the `aircraft` folder). If the dataset is already
...
class AircraftClassDataset(ClassDataset):
    def __init__(
        ...
        super(AircraftClassDataset, self).__init__(
            meta_dataset=meta_dataset,
            meta_train=meta_train,
            meta_val=meta_val,
            meta_test=meta_test,
    ...
    def convert(self):
        ...
        convert(self.root, dataset="aircraft")
