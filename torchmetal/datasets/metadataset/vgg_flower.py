...
class VggFlower(CombinationMetaDataset):
    ...
    ----------
    root : string
        Root directory where the dataset folder `vgg_flower` exists.
    ...
    convert : bool (default: `False`)
        ...
        directory (under the `vgg_flower` folder). If the dataset is already
...
class VggFlowerClassDataset(ClassDataset):
    def __init__(
        ...
        super(VggFlowerClassDataset, self).__init__(
            meta_dataset=meta_dataset,
            meta_train=meta_train,
            meta_val=meta_val,
            meta_test=meta_test,
        ...
        if not self._check_integrity():
            raise RuntimeError("vgg_flower integrity check failed")
    ...
    def convert(self):
        ...
        convert(self.root, dataset="vgg_flower")
...
class VggFlowerDataset(Dataset):
    def __init__(
        ...
        super(VggFlowerDataset, self).__init__(
