...
from torchmetal.datasets.metadataset import data
...
class DatasetSpecification(
  ...
  def initialize(self, restricted_classes_per_split=None):
    ...
    if self.file_pattern not in ['{}.h5', '{}_{}.h5']:
      raise ValueError('file_pattern must be either "{}.h5" or '
                       '"{}_{}.h5" to support shards or splits.')
