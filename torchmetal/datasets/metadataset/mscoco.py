...
class Mscoco(CombinationMetaDataset):
    """
    Parameters
    ----------
    root : string
        Root directory where the dataset folder `mscoco` exists.
    ...
    convert : bool (default: `False`)
        ...
        directory (under the `mscoco` folder). If the dataset is already
...
class MscocoClassDataset(ClassDataset):
    def __init__(
        self,
        root,
        meta_dataset=False,
        ...
        super(MscocoClassDataset, self).__init__(
            meta_dataset=meta_dataset,
            meta_train=meta_train,
            meta_val=meta_val,
            meta_test=meta_test,
        ...
        if not self._check_integrity():
            raise RuntimeError("mscoco integrity check failed")
    ...
    def convert(self):
        ...
        convert(self.root, dataset="mscoco")
