...
class CuBirds(CombinationMetaDataset):
    """
    Parameters
    ----------
    root : string
        Root directory where the dataset folder `cu_birds` exists.
    ...
    convert : bool (default: `False`)
        ...
        directory (under the `cu_birds` folder). If the dataset is already
...
class CuBirdsClassDataset(ClassDataset):
    def __init__(
        self,
        root,
        meta_dataset=False,
        ...
        super(CuBirdsClassDataset, self).__init__(
            meta_dataset=meta_dataset,
            meta_train=meta_train,
            meta_val=meta_val,
            meta_test=meta_test,
        ...
        if not self._check_integrity():
            raise RuntimeError("cu_birds integrity check failed")
    ...
    def convert(self):
        ...
        convert(self.root, dataset="cu_birds")


class CuBirdsDataset(Dataset):
    def __init__(
        self, index, data, character_name, transform=None, target_transform=None
    ):
        super(CuBirdsDataset, self).__init__(
