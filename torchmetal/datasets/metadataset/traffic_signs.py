...
class TrafficSigns(CombinationMetaDataset):
    """
    Parameters
    ----------
    root : string
        Root directory where the dataset folder `traffic_sign` exists.
    ...
    convert : bool (default: `False`)
        ...
        directory (under the `traffic_sign` folder). If the dataset is already
    ...
    def __init__(
        ...
        dataset = TrafficSignsClassDataset(
            root,
        ...
        super(TrafficSigns, self).__init__(
            dataset,
...
class TrafficSignsClassDataset(ClassDataset):
    def __init__(
        self,
        root,
        meta_dataset=False,
        ...
        super(TrafficSignsClassDataset, self).__init__(
            meta_dataset=meta_dataset,
            meta_train=meta_train,
            meta_val=meta_val,
            meta_test=meta_test,
        ...
        if not self._check_integrity():
            raise RuntimeError("traffic_sign integrity check failed")
    ...
    def convert(self):
        ...
        convert(self.root, dataset="traffic_sign")
