...
class Ilsvrc2012(CombinationMetaDataset):
    """
    Parameters
    ----------
    root : string
        Root directory where the dataset folder `ilsvrc2012` exists.
    ...
    convert : bool (default: `False`)
        ...
        directory (under the `ilsvrc2012` folder). If the dataset is already
    ...
    def __init__(
        ...
        dataset = Ilsvrc2012ClassDataset(
            root,
...
class Ilsvrc2012ClassDataset(ClassDataset):
    def __init__(
        self,
        root,
        meta_dataset=False,
        ...
        super(Ilsvrc2012ClassDataset, self).__init__(
            meta_dataset=meta_dataset,
            meta_train=meta_train,
            meta_val=meta_val,
            meta_test=meta_test,
        ...
        if not self._check_integrity():
            raise RuntimeError("ilsvrc2012 integrity check failed")
    ...
    def convert(self):
        ...
        convert(self.root, dataset="ilsvrc2012")
...
class Ilsvrc2012Dataset(Dataset):
    def __init__(
        ...
        super(Ilsvrc2012Dataset, self).__init__(
